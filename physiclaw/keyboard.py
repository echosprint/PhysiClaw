...
def label_keyboard(frame: np.ndarray,
    ...
    QWERTY letters, shift, delete, space are auto-labeled.
    Unknown keys get element="???" for the AI to fill in.
...
def generate_preset(pages: dict[str, list[list[dict]]],
    ...
    Args:
        pages: {"Alpha Keyboard": rows, "Numeric Keyboard": rows, ...}
            Each rows is from label_keyboard().
        bbox_images: {"Alpha Keyboard": "path/to/bbox.png", ...}
