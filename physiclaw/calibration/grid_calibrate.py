...
from physiclaw.vision.grid_detect import (
    detect_red_dots,
    sort_dots_to_grid as _sort_dots_to_grid,
...
def sort_dots_to_grid(dots: list[tuple[float, float]],
    ...
    """Sort dots into row-major grid order with this module's default 3×5 grid."""
    return _sort_dots_to_grid(dots, rows, cols)
