...
The conductor may never import the engine (architecture rule; the
message shapes it does share live in `contract.dto`), so memory.md is
read off the shared path constant here. The contract is
