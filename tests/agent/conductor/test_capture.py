"""Tests for `physiclaw.agent.conductor.capture` — geometry mining,
...
from physiclaw.agent.conductor import capture
from physiclaw.agent.conductor.match import normalize
from physiclaw.agent.conductor.pages import AnchorDecl, PageDecl
