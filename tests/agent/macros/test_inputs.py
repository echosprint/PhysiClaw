"""Tests for `physiclaw.agent.macros.inputs` — input resolution and
...
from physiclaw.agent.macros.inputs import resolve_inputs, substitute
from physiclaw.agent.macros.model import Macro, MacroError, MacroInput
from physiclaw.agent.macros.template import TemplateError, placeholders
