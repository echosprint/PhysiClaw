"""Tests for `physiclaw.agent.macros.store` — discovery under
...
from physiclaw.agent.macros import store as store_mod
from physiclaw.agent.macros.model import MacroError
from physiclaw.agent.macros.scaffold import README_CONTENT
from physiclaw.agent.macros.store import (
    discover_enabled,
